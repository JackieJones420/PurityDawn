/*================ Vendor ================*/
function replaceUrlParam(t, e, o) {
    var r = new RegExp("(" + e + "=).*?(&|$)"),
        i = t;
    return t.search(r) >= 0 ? t.replace(r, "$1" + o + "$2") : i + (i.indexOf("?") > 0 ? "&" : "?") + e + "=" + o;
}
...
!(function (t) {
    t.fn.prepareTransition = function () {
        return this.each(function () {
            ...
            var o = 0;
            t.each(["transition-duration", "-moz-transition-duration", "-webkit-transition-duration", "-o-transition-duration"], function (t, r) {
                o = parseFloat(e.css(r)) || o;
            }),
                0 != o && (e.addClass("is-transitioning"), e[0].offsetWidth);
        });
    };
})(jQuery),
    ...
    Shopify.formatMoney ||
        (Shopify.formatMoney = function (t, e) {
            ...
            switch (("string" == typeof t && (t = t.replace(".", "")), a.match(n)[1])) {
                case "amount":
                    i = r(t, 2);
                    break;
    ...
    (timber.init = function () {
        FastClick.attach(document.body), timber.cacheSelectors(), timber.accessibleNav(), timber.productImageSwitch(), timber.responsiveVideos(), timber.collectionViews(), timber.loginForms();
    }),
    (timber.accessibleNav = function () {
        function t(t) {
            t.removeClass(c), timber.cache.$body.off("touchstart");
        }
        function e(t) {
            t.addClass(p);
        }
        ...
        var r = timber.cache.$navigation,
            i = r.find("a"),
            n = r.children("li").find("a"),
            a = r.find(".site-nav--has-dropdown"),
            s = r.find(".site-nav__dropdown").find("a"),
            c = "nav-hover",
            p = "nav-focus";
        a.on("mouseenter touchstart", function (e) {
            var o = $(this);
            o.hasClass(c) || e.preventDefault(),
                (function (e) {
                    e.addClass(c),
                        setTimeout(function () {
            ...
            i.focus(function () {
                !(function (t) {
                    t.next("ul").hasClass("sub-nav");
                    var r = $(".site-nav__dropdown").has(t).length;
                    r ? e(t.closest(".site-nav--has-dropdown").find("a")) : (o(n), e(t));
                })($(this));
            }),
            i.blur(function () {
                o(n);
    ...
    (timber.productPage = function (t) {
        ...
        if (o) {
            if (o.featured_image) {
                if ("" == ProductObj.originalDress && "" == ProductObj.originalSKU) var p = o.featured_image;
                var u = r[0];
                Shopify.Image.switchImage(p, u, timber.switchImage);
            }
            n.html(Shopify.formatMoney(o.price, e)), o.compare_at_price > o.price ? a.html(Shopify.formatMoney(o.compare_at_price, e)).show() : a.hide();
        } else i.addClass("disabled").prop("disabled", !0), c.html("Unavailable"), s.hide();
    }),
    (timber.productImageSwitch = function () {
        timber.cache.$thumbImages.length &&
            timber.cache.$thumbImages.on("click", function (t) {
                t.preventDefault();
                var e = $(this).attr("href");
                timber.switchImage(e, null, timber.cache.$productImage);
            });
    }),
    (timber.switchImage = function (t, e, o) {
        var r = $(o);
        t.indexOf("cdn.no-toxic.com/") > -1 ? (r.attr("src", t), cloudinaryimg.responsive()) : r.attr("src", t);
    }),
    (timber.responsiveVideos = function () {
        var t = $('iframe[src*="youtube.com/embed"], iframe[src*="player.vimeo"]'),
            e = t.add("iframe#admin_bar_iframe");
        t.each(function () {
        ...
        timber.cache.$changeView.length &&
            timber.cache.$changeView.on("click", function () {
                var t = $(this).data("view"),
                    e = document.URL,
                    o = e.indexOf("?") > -1;
                window.location = o ? replaceUrlParam(e, "view", t) : e + "?view=" + t;
            });
    }),
    ...
    (timber.Drawers = (function () {
        var t = function (t, e, o) {
            ...
            return (
                ...
                (this.config = $.extend(r, o)),
                (this.position = e),
                (this.$drawer = $("#" + t)),
                !!this.$drawer.length && ((this.drawerIsOpen = !1), void this.init())
            );
        };
        return (
            ...
            (t.prototype.trapFocus = function (t, e) {
                var o = e ? "focusin." + e : "focusin";
                t.attr("tabindex", "-1"),
                    t.focus(),
            ...
            (t.prototype.removeTrapFocus = function (t, e) {
                var o = e ? "focusin." + e : "focusin";
                t.removeAttr("tabindex"), $(document).off(o);
            }),
            t
        );
    })()),
    ...
    (Shopify.onCartShippingRatesUpdate = function (t, e) {
        var o = "";
        e.zip && (o += e.zip + ", "), e.province && (o += e.province + ", "), (o += e.country), alert("There are " + t.length + " shipping rates available for " + o + ", starting at " + Shopify.formatMoney(t[0].price) + ".");
    }),
    ...
    (Shopify.pollForCartShippingRatesForDestination = function (t, e, o) {
        ...
        var r = function () {
            jQuery.ajax("/cart/async_shipping_rates", {
                dataType: "json",
                success: function (o, i, n) {
                    200 === n.status ? ("function" == typeof e ? e(o.shipping_rates, t) : Shopify.onCartShippingRatesUpdate(o.shipping_rates, t)) : setTimeout(r, 500);
                },
                error: o,
            });
        };
    ...
    (Shopify.getCartShippingRatesForDestination = function (t, e, o) {
        o = o || Shopify.onError;
        var r = { type: "POST", url: "/cart/prepare_shipping_rates", data: Shopify.param({ shipping_address: t }), success: Shopify.pollForCartShippingRatesForDestination(t, e, o), error: o };
        jQuery.ajax(r);
    }),
    ...
    jQuery.fn.jquery >= "1.4"
        ...
        : ((Shopify.param = function (t) {
              var e = [],
                  o = function (t, o) {
                      (o = jQuery.isFunction(o) ? o() : o), (e[e.length] = encodeURIComponent(t) + "=" + encodeURIComponent(o));
                  };
              if (jQuery.isArray(t) || t.jquery)
                  jQuery.each(t, function () {
                      o(this.name, this.value);
                  });
              else for (var r in t) Shopify.buildParams(r, t[r], o);
              return e.join("&").replace(/%20/g, "+");
          }),
          (Shopify.buildParams = function (t, e, o) {
              jQuery.isArray(e) && e.length
                  ? jQuery.each(e, function (e, r) {
                        rbracket.test(t) ? o(t, r) : Shopify.buildParams(t + "[" + ("object" == typeof r || jQuery.isArray(r) ? e : "") + "]", r, o);
                    })
    ...
    (Shopify.map = function (t, e) {
        for (var o = [], r = 0; r < t.length; r++) o.push(e(t[r], r));
        return o;
    }),
    ...
    (Shopify.Product.prototype.getVariant = function (t) {
        ...
        return t.length != this.options.length
            ...
            : (Shopify.each(this.variants, function (o) {
                  for (var r = !0, i = 0; i < t.length; i++) o["option" + (i + 1)] != t[i] && (r = !1);
                  if (1 == r) return void (e = o);
              }),
              e);
    }),
    ...
    (Shopify.OptionSelectors.prototype.buildSelectors = function () {
        ...
        return Shopify.map(this.selectors, function (t) {
            ...
            if ((e.setAttribute("class", o), r.length > 1)) {
    ...
    (Shopify.OptionSelectorsFromDOM = function (t, e) {
        var o = e.optionNames || [],
            ...
            i = e.delimiter || "/",
            n = this.createProductFromSelector(t, o, r, i);
        (e.product = n), Shopify.OptionSelectorsFromDOM.baseConstructor.call(this, t, e);
    }),
    Shopify.extend(Shopify.OptionSelectorsFromDOM, Shopify.OptionSelectors),
    (Shopify.OptionSelectorsFromDOM.prototype.createProductFromSelector = function (t, e, o, r) {
        ...
        Shopify.each(n, function (t) {
            if (1 == t.nodeType && "option" == t.tagName.toLowerCase()) {
                ...
                0 == e.length && (a = i.length - (o ? 1 : 0));
                var n = i.slice(0, a),
                    c = o ? i[a] : "",
                    p = (t.getAttribute("value"), { available: !t.disabled, id: parseFloat(t.value), price: c, option1: n[0], option2: n[1], option3: n[2] });
                s.push(p);
            }
        });
        var c = { variants: s };
        if (0 == e.length) {
            c.options = [];
            for (var p = 0; p < a; p++) c.options[p] = "option " + (p + 1);
        } else c.options = e;
        return c;
    }),
    (Shopify.SingleOptionSelector = function (t, e, o, r) {
        (this.multiSelector = t), (this.values = r), (this.index = e), (this.name = o), (this.element = document.createElement("select"));
        for (var i = 0; i < r.length; i++) {
            var n = document.createElement("option");
            (n.value = r[i]), (n.innerHTML = r[i]), this.element.appendChild(n);
        }
        return (
            this.element.setAttribute("class", this.multiSelector.selectorClass),
            this.element.setAttribute("data-option", "option" + (e + 1)),
            (this.element.id = t.domIdPrefix + "-option-" + e),
            (this.element.onchange = function (o, r) {
    ...
    (Shopify.setSelectorByValue = function (t, e) {
        for (var o = 0, r = t.options.length; o < r; o++) {
            var i = t.options[o];
            if (e == i.value || e == i.innerHTML) return (t.selectedIndex = o), o;
        }
    }),
    (Shopify.addListener = function (t, e, o) {
    ...
    (Shopify.postLink = function (t, e) {
        ...
        i.setAttribute("method", o), i.setAttribute("action", t);
        for (var n in r) {
            var a = document.createElement("input");
            a.setAttribute("type", "hidden"), a.setAttribute("name", n), a.setAttribute("value", r[n]), i.appendChild(a);
        }
        document.body.appendChild(i), i.submit(), document.body.removeChild(i);
    }),
    (Shopify.CountryProvinceSelector = function (t, e, o) {
        (this.countryEl = document.getElementById(t)),
            (this.provinceEl = document.getElementById(e)),
            (this.provinceContainer = document.getElementById(o.hideElement || e)),
    ...
    (Shopify.CountryProvinceSelector.prototype = {
        ...
        countryHandler: function () {
            var t = this.countryEl.options[this.countryEl.selectedIndex],
                ...
                o = JSON.parse(e);
            if ((this.clearOptions(this.provinceEl), o && 0 == o.length)) this.provinceContainer.style.display = "none";
            else {
                for (var r = 0; r < o.length; r++) {
                    var t = document.createElement("option");
                    (t.value = o[r][0]), (t.innerHTML = o[r][1]), this.provinceEl.appendChild(t);
                }
        ...
        setOptions: function (t, e) {
            var o = 0;
            for (e.length; o < e.length; o++) {
                var r = document.createElement("option");
                (r.value = e[o]), (r.innerHTML = e[o]), t.appendChild(r);
            }
        },
    }),
    (Shopify.CustomerAddress = {
        toggleForm: function (t) {
            var e = document.getElementById("edit_address_" + t),
                o = document.getElementById("view_address_" + t);
            return (e.style.display = "none" == e.style.display ? "" : "none"), (o.style.display = "none" == o.style.display ? "" : "none"), !1;
        },
        toggleNewForm: function () {
            var t = document.getElementById("add_address");
            return (t.style.display = "none" == t.style.display ? "" : "none"), !1;
        },
        destroy: function (t, e) {
            confirm(e || "Are you sure you wish to delete this address?") && Shopify.postLink("/account/addresses/" + t, { parameters: { _method: "delete" } });
        },
    });
